    ...
    <article>
      ...
      <section class="tour-search">
        <div class="container">
          ...
          <form action="common/book_form.php"  method ="post"class="tour-search-form">
            ...
            <div class="input-wrapper">
              ...
              <input type="text" name="email" id="email" required placeholder="Enter Mail"
                class="input-field">
            </div>
...
Đảo Santorini là nơi hoàn hảo cho một nơi nghỉ ngơi cuối tuần. Tự hào với một loạt cảnh quan núi lửa tuyệt đẹp…
          ...
          <a href="tour.php"><button class="btn btn-primary">View All Packages</button></a>
